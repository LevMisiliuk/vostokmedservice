      ...
      <div class="suture-materials__inner">
        ...
        <div class="suture-materials__inner-block">
          <div class="suture-materials__block">
            <h2 class="suture-materials__block-header">Урофікс ПЛ</h2>
            <div class="suture-materials__text">
              <div class="suture-materials__text-block">
                <img src="@/assets/surgery/uroflix-pl.jpeg" alt="Urofix" />
                <div>
                  Пристрій для встановлення ендопротезу-стрічки УроСлінг у
                  позадилонному положенні:<br><br>
                  <ul>
                    <li>• жорсткий багаторазовий</li>
                    <li>
                      • провідник-голка гнучкі провідники (стерильні одноразові по
                      2 шт. в упаковці)
                    </li>
                  </ul>
                </div>
