  ...
  <div class="thigh-pins">
    <div class="container">
      ...
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        <el-breadcrumb-item>
          {{ $t('main.carts.neurosurgery.spinalHooksLinks.closedPedicleHook') }}
        </el-breadcrumb-item>
      </el-breadcrumb>
      ...
      <div class="thigh-pins__inner">
        ...
        <div class="thigh-pins__card">
          ...
          >
            <el-table-column
              :label="$t('main.carts.neurosurgery.closedPedicleHook.table.first')"
              prop="first"
            />
            <el-table-column
              :label="$t('main.carts.neurosurgery.closedPedicleHook.table.second')"
              prop="second"
            />
          </el-table>
        </div>
