<template>
  <NeurosurgeryLayuot>
    <div class="spinal-hooks__carts">
      <a
        v-for="cart in spinalHooksCarts"
        :key="cart"
        class="spinal-hooks__cart"
        :href="cart.link"
      >
        <img
          :src="cart.img"
          alt=""
          class="spinal-hooks__cart-img"
        />
        <div class="spinal-hooks__cart-title">
          {{ cart.title }}
        </div>
      </a>
    </div>
...
export default {
  setup() {
    ...
    const spinalHooksCarts = computed(() => [
      {
