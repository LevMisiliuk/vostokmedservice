<template>
  <div class="neurosurgery-layuot">
    <div class="container">
      ...
      <div class="neurosurgery-layuot__inner">
        <LeftLinksMenu :typeLink="'neurosurgery'" :linksData="neurosurgeryLinks" />
        <div class="neurosurgery-layuot__block">
          <slot></slot>
        </div>
      </div>
    </div>
