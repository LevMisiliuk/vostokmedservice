<template>
  <div class="small-inserts-with-angular-stability">
    <div class="container">
      <MainHeader />
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        <el-breadcrumb-item>
          {{
            $t('main.carts.traumatology.links.smallInsertsWithAngularStability')
          }}
        </el-breadcrumb-item>
      </el-breadcrumb>

      <div class="small-inserts-with-angular-stability__inner">
        <LeftLinksMenu />
        <div class="small-inserts-with-angular-stability__card">
          <ProductInfoCard
          ...
          />
          <ProductTableHeader
            :title="$t('main.carts.traumatology.smallInsertsWithAngularStability.straightPlate')"
          ...
          >
            ...
            <el-table-column
              :label="
                $t('main.carts.traumatology.hipProximalPins.table.second')
              "
              prop="second"
            />
            <el-table-column
            ...
            <el-table-column
              :label="
                $t('main.carts.traumatology.hipProximalPins.table.fourth')
              "
              prop="fourth"
            />
            <el-table-column
          ...
          >
            ...
            >
              ...
              <el-table-column
                :label="
                  $t(
                    'main.carts.traumatology.hipProximalPins.thirdTable.second'
                  )
                "
                prop="second"
              />
              ...
              <el-table-column
                :label="
                  $t(
                    'main.carts.traumatology.hipProximalPins.thirdTable.fourth'
                  )
                "
                prop="fourth"
              />
...
.small-inserts-with-angular-stability {
  &__inner {
    width: 100%;
    display: flex;
