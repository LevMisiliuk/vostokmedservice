<template>
  <ToolsAndEquipmentLayuot>
    <div class="medical-cabinets__carts">
      <a
        v-for="cart in medicalCabinetsCarts"
        :key="cart"
        class="medical-cabinets__cart"
        :href="cart.link"
      >
        <img
          :src="cart.img"
          alt=""
          class="medical-cabinets__cart-img"
        />
        <div class="medical-cabinets__cart-title">
          {{ cart.title }}
        </div>
      </a>
    </div>
