  ...
  <div class="luminaire-one">
    <div class="container">
      ...
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        >
        <el-breadcrumb-item :to="`/${$i18n.locale}/catalog/tools-and-equipment/cardiology`"
          >{{$t('main.carts.toolsAndEquipment.title')}}</el-breadcrumb-item
        >
        <el-breadcrumb-item>
          <a>{{$t('main.carts.toolsAndEquipment.cardiology.links.electrocardiogrphSingleThreeChannel')}}</a>
        </el-breadcrumb-item>
      </el-breadcrumb>

      <div class="luminaire-one__inner">
        <LeftLinksMenu />
        <div class="luminaire-one__card">
          <ProductInfoCard
            :image="data[0].image"
            :title="data[0].title"
            :subtitle="data[0].subtitle"
            :productsParams="data[0].productsParams"
          />
          <div class="card">
