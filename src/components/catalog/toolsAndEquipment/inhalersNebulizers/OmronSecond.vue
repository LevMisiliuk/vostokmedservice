<template>
  <div class="compressorInhaler-boreal">
    <div class="container">
      <MainHeader />
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        >
        <el-breadcrumb-item :to="`/${$i18n.locale}/catalog/tools-and-equipment/inhalers-nebulizers`"
          >{{$t('main.carts.toolsAndEquipment.title')}}</el-breadcrumb-item
        >
        <el-breadcrumb-item>
          <a>{{$t('main.carts.toolsAndEquipment.inhalersNebulizers.links.omronNeC29')}}</a>
        </el-breadcrumb-item>
      </el-breadcrumb>

      <div class="compressorInhaler-boreal__inner">
        <LeftLinksMenu />
        <div class="compressorInhaler-boreal__card">
          <ProductInfoCard
            :image="omronNeC29Data[0].image"
            :title="omronNeC29Data[0].title"
            :subtitle="omronNeC29Data[0].subtitle"
            :productsParams="omronNeC29Data[0].productsParams"
          />
          <div class="card">
