  ...
  <div class="compressorInhaler-boreal">
    <div class="container">
      ...
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        >
        <el-breadcrumb-item>
          <a>{{$t('main.carts.toolsAndEquipment.inhalersNebulizers.links.omronNeC30')}}</a>
        </el-breadcrumb-item>
      </el-breadcrumb>
      ...
      <div class="compressorInhaler-boreal__inner">
        ...
        <div class="compressorInhaler-boreal__card">
          <ProductInfoCard
            :image="omronNeC30Data[0].image"
            :title="omronNeC30Data[0].title"
            :subtitle="omronNeC30Data[0].subtitle"
            :productsParams="omronNeC30Data[0].productsParams"
          />
          <div class="card">
