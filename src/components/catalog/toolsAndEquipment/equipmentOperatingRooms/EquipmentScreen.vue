<template>
  <ToolsAndEquipmentLayuot>
    <div class="equipment__carts">
      <a
        v-for="cart in equipmentCarts"
        :key="cart"
        class="equipment__cart"
        :href="cart.link"
      >
        <img
          :src="cart.img"
          alt=""
          class="equipment__cart-img"
        />
        <div class="equipment__cart-title">
          {{ cart.title }}
        </div>
      </a>
    </div>
