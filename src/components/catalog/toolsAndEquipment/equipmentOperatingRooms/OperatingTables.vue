<template>
  <ToolsAndEquipmentLayuot>
    <div class="operating-tables__carts">
      <a
        v-for="cart in operatingTablesCarts"
        :key="cart"
        class="operating-tables__cart"
        :href="cart.link"
      >
        <img
          :src="cart.img"
          alt=""
          class="operating-tables__cart-img"
        />
        <div class="operating-tables__cart-title">
          {{ cart.title }}
        </div>
      </a>
    </div>
