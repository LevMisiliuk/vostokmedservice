<template>
  <div class="electric-table-fifth">
    <div class="container">
      <MainHeader />
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        >
        <el-breadcrumb-item>
          <a>{{$t('main.carts.toolsAndEquipment.equipmentOperatingRooms.links.operatingTable3006')}}</a>
        </el-breadcrumb-item>
      </el-breadcrumb>

      <div class="electric-table-fifth__inner">
        <LeftLinksMenu />
        <div class="electric-table-fifth__card">
          <ProductInfoCard
            :image="operatingTable3006Data[0].image"
            :title="operatingTable3006Data[0].title"
            :subtitle="operatingTable3006Data[0].subtitle"
            :productsParams="operatingTable3006Data[0].productsParams"
          />
          <div class="card">
