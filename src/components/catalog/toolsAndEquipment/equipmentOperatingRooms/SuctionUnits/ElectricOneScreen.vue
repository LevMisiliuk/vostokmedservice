  ...
  <div class="electric-7a23v">
    <div class="container">
      ...
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        >
        <el-breadcrumb-item>
          <a>{{$t('main.carts.toolsAndEquipment.equipmentOperatingRooms.links.electric7a23v')}}</a>
        </el-breadcrumb-item>
      </el-breadcrumb>

      <div class="electric-7a23v__inner">
        <LeftLinksMenu />
        <div class="electric-7a23v__card">
          <ProductInfoCard
            :image="electric7a23vData[0].image"
            :title="electric7a23vData[0].title"
            :subtitle="electric7a23vData[0].subtitle"
            :productsParams="electric7a23vData[0].productsParams"
          />
          <div class="card">
