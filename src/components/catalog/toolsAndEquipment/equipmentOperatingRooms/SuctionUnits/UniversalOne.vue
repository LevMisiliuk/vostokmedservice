  ...
  <div class="universal-7ed">
    <div class="container">
      ...
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        >
        <el-breadcrumb-item>
          <a>{{$t('main.carts.toolsAndEquipment.equipmentOperatingRooms.links.universal7ed')}}</a>
        </el-breadcrumb-item>
      </el-breadcrumb>

      <div class="universal-7ed__inner">
        <LeftLinksMenu />
        <div class="universal-7ed__card">
          <ProductInfoCard
            :image="universal7edData[0].image"
            :title="universal7edData[0].title"
            :subtitle="universal7edData[0].subtitle"
            :productsParams="universal7edData[0].productsParams"
          />
          <div class="card">
