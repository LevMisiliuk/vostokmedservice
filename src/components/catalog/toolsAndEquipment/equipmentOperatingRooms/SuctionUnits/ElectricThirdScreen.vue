  ...
  <div class="electric-7s">
    <div class="container">
      ...
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        >
        <el-breadcrumb-item>
          <a>{{$t('main.carts.toolsAndEquipment.equipmentOperatingRooms.links.electric7s')}}</a>
        </el-breadcrumb-item>
      </el-breadcrumb>

      <div class="electric-7s__inner">
        <LeftLinksMenu />
        <div class="electric-7s__card">
          <ProductInfoCard
            :image="electric7sData[0].image"
            :title="electric7sData[0].title"
            :subtitle="electric7sData[0].subtitle"
            :productsParams="electric7sData[0].productsParams"
          />
          <div class="card">
