<template>
  <div class="luminaire-reflect-second">
    <div class="container">
      <MainHeader />
      <el-breadcrumb class="breadcrumb" separator="/">
        ...
        >
        <el-breadcrumb-item>
          <a>{{$t('main.carts.toolsAndEquipment.equipmentOperatingRooms.links.luminaireReflectorEEma6')}}</a>
        </el-breadcrumb-item>
      </el-breadcrumb>
      <div class="luminaire-reflect-second__inner">
        <LeftLinksMenu />
        <div class="luminaire-reflect-second__card">
          <ProductInfoCard
            :image="luminaireReflectorEEma6Data[0].image"
            :title="luminaireReflectorEEma6Data[0].title"
            :subtitle="luminaireReflectorEEma6Data[0].subtitle"
            :productsParams="luminaireReflectorEEma6Data[0].productsParams"
          />
          <div class="card">
