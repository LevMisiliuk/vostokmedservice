<template>
  <ToolsAndEquipmentLayuot>
    <div class="suction-units__carts">
      <a
        v-for="cart in SuctionUnitsCarts"
        :key="cart"
        class="suction-units__cart"
        :href="cart.link"
      >
        <img
          :src="cart.img"
          alt=""
          class="suction-units__cart-img"
        />
        <div class="suction-units__cart-title">
          {{ cart.title }}
        </div>
      </a>
    </div>
