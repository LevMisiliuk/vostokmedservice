<template>
  <ToolsAndEquipmentLayuot>
    <div class="air-sterilizer__carts">
      <a
        v-for="cart in AirSterilizerCarts"
        :key="cart"
        class="air-sterilizer__cart"
        :href="cart.link"
      >
        <img
          :src="cart.img"
          alt=""
          class="air-sterilizer__cart-img"
        />
        <div class="air-sterilizer__cart-title">
          {{ cart.title }}
        </div>
      </a>
    </div>
