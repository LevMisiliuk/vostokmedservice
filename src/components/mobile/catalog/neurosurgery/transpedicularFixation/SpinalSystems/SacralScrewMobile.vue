<template>
  <MobilePageWrapper>
    <div class="default_mobile__card">
      ...
      >
        <el-table-column
            :label="$t('main.carts.neurosurgery.sacralScrew.table.first')"
            prop="first"
            min-width="140px"
        />
        <el-table-column
            :label="$t('main.carts.neurosurgery.sacralScrew.table.second')"
            prop="second"
            min-width="140px"
        />
        <el-table-column
            :label="$t('main.carts.neurosurgery.sacralScrew.table.third')"
            prop="third"
            min-width="140px"
        />
      </el-table>
